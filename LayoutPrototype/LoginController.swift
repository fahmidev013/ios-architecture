...
class LoginController: UIViewController, LoginControllerDelegate {
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pc.currentPageIndicatorTintColor = UIColor.rgb(0, 153, 204)
        return pc
    }()
    ...
    lazy var skipButton: UIButton = {
        ...
        btn.setTitleColor(UIColor.rgb(0, 153, 204), for: .normal)
    ...
    func finishedLogIn() {
        ...
        //guard let mainNavigationController = rootViewController as? MainNavViewController else { return }
